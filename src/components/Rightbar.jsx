  ...
  return (
    <Container className={classes.container}>
      ...
      <ImageList rowHeight={100} style={{ marginBottom: 20 }} cols={2}>
        <ImageListItem>
          <img src="https://material-ui.com/static/images/image-list/breakfast.jpg" alt="item-image" />
        </ImageListItem>
        <ImageListItem>
          <img src="https://material-ui.com/static/images/image-list/burgers.jpg" alt="item-image" />
        </ImageListItem>
        <ImageListItem>
          <img src="https://material-ui.com/static/images/image-list/camera.jpg" alt="item-image" />
        </ImageListItem>
        <ImageListItem>
          <img src="https://material-ui.com/static/images/image-list/morning.jpg" alt="item-image" />
        </ImageListItem>
        <ImageListItem>
          <img src="https://material-ui.com/static/images/image-list/hats.jpg" alt="item-image" />
        </ImageListItem>
        <ImageListItem>
          <img src="https://material-ui.com/static/images/image-list/vegetables.jpg" alt="item-image" />
        </ImageListItem>
      </ImageList>
